function [idlin_sim,idsat_sim,vtlin_sim,vtsat_sim] = read_sim_idsat(filename_meas,corner,lminmultipler)

filename_meas_FF = 'netlist_vth_t_FF_lib.measure';
...
Index_meas_wn_c = strfind(text2,'idlin');
...
idsat_sim=str2double(text2(Index_meas_idsat+5));
...
idlin_sim=str2double(text2(Index_meas_idlin+5));
...
vtlin_sim=str2double(text2(Index_meas_vtlin+5));
...
vtsat_sim=str2double(text2(Index_meas_vtsat+5));
