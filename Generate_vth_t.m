function filename = Generate_vth_t(lib,corner,modelname,W,L,m,temperature,temp_start,temp_stop,VGmax,VDD,VG_Step,VDlin,vdd_sat,flag_fet,Terminals,shrink,tdem1)
% BIAS
...
filename=['netlist_vth_t_' tdem '_' corner '.sp'];
